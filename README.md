...
| Where the location being searched for the item coincides with the thief's work location the thief ends up in two places at once. They are at the location while simultaneously sitting in a jail having just been arrested. | This is a current flaw in the underlining logic that was realised too late to be fixed | Unresolved: doesn't impact on the running of the program but is a quirk that may be noticed by players. |
